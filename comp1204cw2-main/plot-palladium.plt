set terminal png
set output "palladium-price-data.png"
set datafile separator ","
set title "Price of Palladium change in 10 Days"
set xlabel "Datetime"
set xdata time
